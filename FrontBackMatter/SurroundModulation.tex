...
\begin{equation}
  \eta_{Sst} = \eta_{Loc-Exc} + \eta_{Lat-Exc-Sst}
\end{equation}

Additionally the $\eta_{Lat-Exc-Sst}$ term has hysteresis and an
exponential activation function applied to it such that it's
contribution is given by:

\begin{equation}
  \eta_{Lat-Exc-Sst} (t + \delta\eta) = (\eta(t) + \tau \big[ \eta(t+\delta\eta - \eta(t) \big])^\beta
\end{equation}
