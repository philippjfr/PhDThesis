...
transformed sub-cortically).  Identifying and understanding the
...
\begin{figure}
	...
	\caption{Diagram of the LESPI V1 stage of the model showing the
      ...
      (blue) connections. Dark colors indicate the kernel radii, while
...
preferences (swapping ON for OFF excitation) will be anti-correlated
...
\begin{figure}
	...
	\caption[Example image patterns used to train the model] {Example
      ...
      randomly positioned and rotated. A) Forest and grass from the
      outdoor dataset taken in Gif-sur-Yvette. B) Inside of a
      tree-shrew cage taken in David Fitzpatrick's animal rearing
      facilities at Duke University. C) \cite{Serre2007} target
      patterns of animals and natural landscapes.}
...
\begin{figure}
	...
	\caption{Orientation-contrast stimulus measuring modulation by a
      ...
      responding to a central sine grating disk of the same spatial
      frequency.  Stimulus is varied by center and surround contrast,
      surround orientation and the offset between the central disk and
      the surround annulus.}
	\label{ORC_Stimulus}
\end{figure}
...
\begin{figure}
	...
	\caption[Time-course of neural and synaptic projection responses
      ...
      model. Visualizes how interneuron activity and lateral excitatory
...
relatively limited circumstances, such as at the borders of different
...
modulation phenomena such as pop-out and orientation contrast
