...
normalization pool size, as we can already see a small amounts of
shift in Figure~\ref{LGNSizeTuning}, which is not evident in the GCAL
...
any long-range influences any changes in the fit is must likely
mediated by the relatively short-range connections in the model.

Using the subtractive DoG model we did find significant shifts in the
