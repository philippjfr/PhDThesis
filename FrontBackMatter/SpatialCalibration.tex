...
Figure~\ref{LGNFrequencyTuning}, showing a slight contrast-dependent
shift toward higher frequencies at higher contrasts.
...
%jbednar: no section should have four numbers; use * or reorganize to avoid
...
the magnification factor, we can establish that we would expect roughly 4.2
...
The final model parameters are summarized in Table~\ref{LGNTuning} and
