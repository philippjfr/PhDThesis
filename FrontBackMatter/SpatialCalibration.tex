...
%%
%% jbednar: It's almost never a good idea to use words as multiple adjacent 
%% lowercase letters in equations--they are always ambiguous about
%% whether it's three variables s, u, and b, or one label 'sub'.  Why
%% not _s and _d?
\begin{equation}
...
the neuron (Spearman's $\rho=0.59$, $p<10^{-184}$).
