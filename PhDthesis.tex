...
\cleardoublepage\include{LaySummary} % Uncomment and create a Foreword.tex to include a foreword

\cleardoublepage\include{Abstract} % Abstract page
%
%
...
%----------------------------------------------------------------------------------------
\include{FrontBackMatter/GeneralIntroduction} %
\include{FrontBackMatter/LiteratureReview} %
\include{FrontBackMatter/ReproducibleScience} %
\include{FrontBackMatter/SpatialCalibration} %
\include{FrontBackMatter/ExploringInhibition} %
\include{FrontBackMatter/SurroundModulation} %
\include{FrontBackMatter/LateralStatistics} %
\include{FrontBackMatter/Chapter_GeneralDiscussion} 
\include{FrontBackMatter/Conclusion}
